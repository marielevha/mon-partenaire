...
export const cgMessages = {
  ...
  auth: {
    ...frMessages.auth,
    loginPage: {
      ...frMessages.auth.loginPage,
      title: "Kokota",
      description: "Zonga na espace partenaire na yo.",
      sideTitle: "Sala noki, tonga malamu.",
      switchText: "Ozali nanu na compte te?",
      switchLinkText: "Kosala compte",
    },
    signupPage: {
      ...frMessages.auth.signupPage,
      title: "Kosala compte",
      sideTitle: "Luka coequipier ya malamu.",
      switchText: "Ozali na compte deja?",
      switchLinkText: "Kokota",
    },
    loginForm: {
      ...frMessages.auth.loginForm,
      emailLabel: "Email",
      passwordLabel: "Mot de passe",
      showPassword: "Lakisa",
      hidePassword: "Bomba",
      forgotPassword: "Obosani mot de passe?",
      supportText: "Lisungi 7/7",
      submitIdle: "Kokota",
      submitPending: "Connexion...",
    },
    signupForm: {
      ...frMessages.auth.signupForm,
      nameLabel: "Kombo",
      phoneLabel: "Telephone",
      emailLabel: "Email",
      showPassword: "Lakisa",
      hidePassword: "Bomba",
      submitIdle: "Kosala compte na ngai",
