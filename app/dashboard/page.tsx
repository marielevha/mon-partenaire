...
export const metadata: Metadata = {
  ...
  description: "Suivez vos projets dans votre espace admin.",
};
    ...
    <section className="space-y-6">
        ...
        <div className="dashboard-panel rounded-2xl p-6">
          ...
          <div className="dashboard-faint mt-6 grid gap-3 text-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-emerald-600 dark:text-emerald-300">{publishedProjects}</span>
            </div>
            <div className="flex items-center justify-between">
              <span>Projets brouillons</span>
              <span className="font-semibold text-amber-600 dark:text-amber-200">{draftProjects}</span>
            </div>
            <div className="flex items-center justify-between">
              <span>Besoins ouverts</span>
              <span className="font-semibold">{openNeeds}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="dashboard-panel rounded-2xl p-4">
          ...
          <p className="mt-2 text-2xl font-semibold text-emerald-600 dark:text-emerald-300">{publishedProjects}</p>
        </div>
        <div className="dashboard-panel rounded-2xl p-4">
          <p className="dashboard-faint text-xs uppercase tracking-wide">Brouillons</p>
          <p className="mt-2 text-2xl font-semibold text-amber-600 dark:text-amber-200">{draftProjects}</p>
        </div>
        <div className="dashboard-panel rounded-2xl p-4">
        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="dashboard-faint mt-1 text-sm">
              Gérez les statuts et suivez l&apos;avancement de vos besoins.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-3">
              {projects.map((project) => {
                ...
                return (
                  <div
                    key={project.id}
                    className="dashboard-panel-soft rounded-xl p-4"
                  >
